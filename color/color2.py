...
def main():
    ...
    print(f"{crayons.blue('red')} white {crayons.red('blue')}")  # f-string (newest version of str templating)

    crayons.disable() # disables the crayons package

    # this line should NOT have color as crayons is disabled
    print(f"{crayons.yellow('red')} white {crayons.red('blue')}")  # f-string (newest version of string templating)

    crayons.DISABLE_COLOR = False # enable the crayons package

    # This line will print in color because color is enabled
    print(f"{crayons.yellow('red')} white {crayons.blue('blue')}")  # f-string (newest version of string templating)

    # print 'red string' in red
    print(crayons.red('red string', bold=True))

    # print 'yellow string' in yellow
    print(crayons.cyan('yellow string', bold=True))

    # print 'magenta string' in magenta
    print(crayons.black('magenta string', bold=True))
